...
(function() {
  ...
  customCheckoutController.init();
            ...
            var vcInitObj =  {
                apikey: "PE8HNSLJ48ICX8S0WUAL135Sj1QFxLXKXu72WohWwxf8LvBXo",
                externalClientId: "",
                settings: {
            ...
            function vcInit(active){
                if (active){
                    ...
                    V.on("payment.success", function(payment)
                        {
                            document.getElementById('frmPayment').visaCheckoutCallId.value = payment.callid;
                            CheckoutVisaCheckout();
                        }
                    ());
